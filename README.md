...
1. Open MATLAB
2. Run one of the provided examples. Each example can be identified by the *main* keyword. The examples demonstrate how to solve elliptic PDE problems on polytopal meshes using different numerical methods, including FEM, VEM and Z-FEM. 
